...
```sh
git clone https://github.com/RexMortem/C_Course-Optional_Session_24
```

2) Read **OptionalSession.pdf**; if you're on DCS machines, you can do this using **evince** or **okular** among other tools. If you're using your own machine, then most web browsers should work. Regardless of the device, I personally prefer opening pdfs in Chrome, Firefox or similar. 
    ...
    - Alternatively, you can also read through the markdown file **OptionalSession.md** 
